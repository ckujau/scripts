...
# certain number of) passwords of a certain length, pwqgen generates
# passwords of a certain randomness (in bits). With random=85 (the highest
...
# The following would be more correct, but takes much longer too:
